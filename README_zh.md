...
你的苦工也是你的私人教练。内置帕维尔风格每日锻炼模式 — 那个告诉你"work work"的兽人现在会叫你趴下做二十个俯卧撑。
...
peon trainer log 25 pushups  # 记录你做的运动
...
教练提醒依附于你的编程会话。当你开始新会话时，苦工会立即鼓励你在写任何代码之前先做俯卧撑。然后在活跃编程期间每约 20 分钟，你会听到苦工喊你做更多次数。无需后台守护进程。使用 `peon trainer log` 记录你的次数，进度在午夜自动重置。
